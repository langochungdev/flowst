...
const annotations = {
    ...
    main: [
        { id: 'main-dur', label: 'Focus time', sub: 'Set Pomodoro block length per session', side: 'top', targetSelector: '.select-group > :nth-child(1)', posY: 0.10 },
        { id: 'main-cat', label: 'Task category', sub: 'Tag & color-code each session', side: 'top', targetSelector: '.select-group > :nth-child(3)', posY: 0.10 },
    ...
    settings: [
        { id: 'set-sound', label: 'Custom sound', sub: 'Upload MP3/WAV or pick a built-in chime', side: 'top', targetSelector: '.custom-select', posY: 0.10 },
